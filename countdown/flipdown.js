...
class FlipDown {
  constructor(uts, el = 'flipdown', opt = {}) {
    ...
    this.epoch = new Date("Mar 23, 2020 08:00:00").getTime()/1000;
  ...
  **/
  _tick() {
    ...
    diff =diff- this.clockValues.d * 86400;

    // Hours remaining
    this.clockValues.h = Math.floor(diff / 3600);
    diff =diff- this.clockValues.h * 3600;

    // Minutes remaining
    this.clockValues.m = Math.floor(diff / 60);
    diff =diff- this.clockValues.m * 60;
